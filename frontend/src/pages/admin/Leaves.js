...
const Leaves = () => {
  ...
  const handleReview = async (status) => {
    setReviewing(true);
    try {
      await api.patch(`/leaves/${selectedLeave._id}/review`, {
        status,
        adminNote,
      });
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      {leave.status === "pending" ? (
                        ...
                        <div>
                          <p className="text-slate-500 text-xs">
                            by {leave.reviewedBy?.fullName || "Admin"}
                          </p>
                          {leave.adminNote && (
            ...
            >
              ...
              {leave.status !== "pending" && leave.adminNote && (
                <div className="pt-3 border-t border-white/5">
                  <p className="text-slate-500 text-xs">
                    Admin note:{" "}
                    <span className="text-slate-300">{leave.adminNote}</span>
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-white/3 border border-white/5 rounded-xl p-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white">
                    {selectedLeave.balanceAtRequest} days
                  </span>
                </div>
